...
יש להגיש קישור לגיטהאב, ולשים בו מדריך - קובץ רידמי המסביר איך בדיוק להתקין ולהשתמש את המערכת. המדריך צריך לתאר כל שלב בהתקנה, כולל התקנות של תוכנות נדרשות, איזה גירסה בדיוק צריך להתקין, איך לפתור תקלות בתהליך ההתקנה, וכו'.
